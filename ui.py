...
class Main(QMainWindow):
    ...
    def getCalibrationImage(self):
        try:
            ...
            self.ui.cali_s_label.setText(
                'Image({self.height},{self.width})'.format(self=self.ref))
    ...
    def getAnalysisImage(self):
        try:
            ...
            self.ui.analysis_s_label.setText(
                'Image({self.height},{self.width})'.format(self=self.img))
    ...
    def analyseImage(self):
        ...
        self.graphWidget.plot(
            self.list[:, 0], self.list[:, 1], pen=pen, clear=True)
